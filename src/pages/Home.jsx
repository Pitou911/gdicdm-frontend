            ...
            <div className='bg-white py-13'>
                <div className='max-w-325 mx-auto px-8'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
                        <div className='bg-white border border-gray-200 rounded-xl p-7 shadow transition-shadow hover:shadow-lg'>
                            ...
                            <div style={{display: 'flex', alignItems: 'center', gap: '24px'}}>
                                <svg width='110' height='110' viewBox="0 0 110 110" style={{flexShrink: 1}}>
                                    ...
                                    <text x="55" y="51" textAnchor="middle" fontFamily="Sora,sans-serif" fontSize="15" fontWeight="700" fill="#1e293b">39%</text>
                                    <text x="55" y="65" textAnchor="middle" fontFamily="JetBrains Mono,monospace" fontSize="8" fill="#94a3b8">Multi.</text>
                                </svg>
                                <div style={{flex: 1}}>
                                    <div className='flex items-center gap-2 mb-2 text-[13px] text-(--text2)'><div className='w-2.5 h-2.5 rounded-[3px] shrink-0 bg-teal'></div>Multilateral<span className='ml-auto font-mono text-[11.5px] font-semibold text-(--text)'>39%</span></div>
                                    <div className='flex items-center gap-2 mb-2 text-[13px] text-(--text2)'><div className='w-2.5 h-2.5 rounded-[3px] shrink-0 bg-blue'></div>Bilateral<span className='ml-auto font-mono text-[11.5px] font-semibold text-(--text)'>37%</span></div>
                                    <div className='flex items-center gap-2 mb-2 text-[13px] text-(--text2)'><div className='w-2.5 h-2.5 rounded-[3px] shrink-0 bg-teal-3'></div>Commercial<span className='ml-auto font-mono text-[11.5px] font-semibold text-(--text)'>24%</span></div>
                                </div>
                            </div>
                        </div>
                        <div className='bg-white border border-gray-200 rounded-xl p-7 shadow transition-shadow hover:shadow-lg'>
                            <div className='text-[15px] font-display text-gray-900 mb-1'>Debt-to-GDP Trend</div>
                        ...
                        <div className='bg-white border border-gray-200 rounded-xl p-7 shadow transition-shadow hover:shadow-lg'>
                            <div className='text-[15px] font-display text-gray-900 mb-1'>Debt Service Schedule</div>
                            <div className='font-mono text-[10px] text-gray-500 mb-5'>2026 - 2030 · USD Millions</div>
                            <div className="flex items-end gap-2 h-32.5">
                                <div className="flex-1 flex flex-col items-center gap-1.25 h-full">
                                    ...
                                    <div className="flex-1 w-full bg-light rounded-[4px] flex items-end overflow-hidden"><div className="w-full bg-linear-to-b from-teal-2 to-teal rounded-[4px] transition-[height] duration-800" style={{ height: '62%' }}></div></div>
                                    <div className="font-mono text-[10px] text-text-3">2025</div>
                                </div>
                                <div className="flex-1 flex flex-col items-center gap-1.25 h-full">
                                    <div className="font-mono text-[10px] text-text-3">780</div>
                                    <div className="flex-1 w-full bg-light rounded-[4px] flex items-end overflow-hidden"><div className="w-full bg-linear-to-b from-teal-2 to-teal rounded-[4px] transition-[height] duration-800" style={{ height: '78%' }}></div></div>
                                    <div className="font-mono text-[10px] text-text-3">2026</div>
                                </div>
                                <div className="flex-1 flex flex-col items-center gap-1.25 h-full">
                                    <div className="font-mono text-[10px] text-text-3">550</div>
                                    <div className="flex-1 w-full bg-light rounded-[4px] flex items-end overflow-hidden"><div className="w-full bg-linear-to-b from-teal-2 to-teal rounded-[4px] transition-[height] duration-800" style={{ height: '55%' }}></div></div>
                                    <div className="font-mono text-[10px] text-text-3">2027</div>
                                </div>
                                <div className="flex-1 flex flex-col items-center gap-1.25 h-full">
                                    <div className="font-mono text-[10px] text-text-3">880</div>
                                    <div className="flex-1 w-full bg-light rounded-[4px] flex items-end overflow-hidden"><div className="w-full bg-linear-to-b from-teal-2 to-teal rounded-[4px] transition-[height] duration-800" style={{ height: '88%' }}></div></div>
                                    <div className="font-mono text-[10px] text-text-3">2028</div>
                                </div>
                                <div className="flex-1 flex flex-col items-center gap-1.25 h-full">
                                    <div className="font-mono text-[10px] text-text-3">680</div>
                                    <div className="flex-1 w-full bg-light rounded-[4px] flex items-end overflow-hidden"><div className="w-full bg-linear-to-b from-teal-2 to-teal rounded-[4px] transition-[height] duration-800" style={{ height: '68%' }}></div></div>
