export default function NewsCard({ icon, category, title, date, onClick}){
    return (
        <div className="bg-white border border-light-2 rounded-radius-sm overflow-hidden cursor-pointer transition-all duration-200 shadow-(--shadow-sm) hover:shadow-(--shadow-md) hover:-translate-y-0.5 hover:border-teal-3" onClick={onClick}>
